$(function(){
	$('#proses').click(function(){
    	...
    	$('#hasil').val("Rp "+prediksiHarga()+".000.000,00");	
	...
	*/
	...
	/**
	*  mencari nilai keanggotaan himpunan lebar jalan sempit
	*  @return nilai keanggotaan di himpunan lebar jalan sempit
	*/
	function lebarSempit(){
		if(lebar <= 1){
			return 1;
		}else if(lebar > 1 && lebar < 3){
			return (3 - lebar) / 2;
		}else{
			return 0;
		}
	...
	/**
	*  mencari nilai keanggotaan himpunan lebar sedang
	*  @return nilai keanggotaan di himpunan lebar sedang
	*/
	function lebarSedang(){
		if(lebar >= 3 && lebar <= 5){
			return 1;
		}else if(lebar > 1 && lebar < 3){
			return (lebar - 1) / 2;
		}else if(lebar > 5 && lebar < 7){
			return (7 - lebar) / 2;
		}else{
			return 0;
		}
	...
	*/
	...
	/**
	*  mencari nilai keanggotaan himpunan luas ukuran rumah sempit
	*  @return nilai keanggotaan di himpunan luas ukuran rumah sempit
	*/
	...
	/**
	*  mencari nilai keanggotaan himpunan luas ukuran rumah sedang
	*  @return nilai keanggotaan di himpunan luas ukuran rumah sedang
	*/
	...
	/**
	*  mencari nilai keanggotaan himpunan ukuran luas tanah rumah
	*  @return nilai keanggotaan di himpunan ukuran luas tanah rumah
	*/
	function ukuranLuas(){
		if(ukuran >= 18){
			return 1;
	...
	*/
	...
	/**
	*  menghitung semua aturan dan menentukan harga jual rumah
	*  @return harga
	*/
